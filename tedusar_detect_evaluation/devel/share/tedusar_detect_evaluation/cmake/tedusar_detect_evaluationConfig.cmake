...
if(NOT "/home/plorenz/ros_pkg/src/tedusar_perception/tedusar_detect_evaluation/devel/include " STREQUAL " ")
  set(tedusar_detect_evaluation_INCLUDE_DIRS "")
  set(_include_dirs "/home/plorenz/ros_pkg/src/tedusar_perception/tedusar_detect_evaluation/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tedusar_detect_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/plorenz/ros_pkg/src/tedusar_perception/tedusar_detect_evaluation/${idir}'.  Ask the maintainer 'jester <jester@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/plorenz/ros_pkg/src/tedusar_perception/tedusar_detect_evaluation/devel/lib;/home/plorenz/ros_pkg/devel/lib;/opt/ros/indigo/lib)
